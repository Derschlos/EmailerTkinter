...
class ContactEditPage(tk.Frame):
    def __init__(self,parent, controller):
##        tk.Frame.__init__(self, parent)
        super().__init__(parent)
        self.pageName = 'ContactEditPage'
        self.controller = controller
        self.savedChanges = True
        self.bg = self.controller.configVars['ContactEditPageColor']
    ...
    def onRaise(self):
        ...
        self.controller.root.geometry(self.controller.configVars['ContactEditPageDimensions'])
        self.bg= self.controller.configVars['ContactEditPageColor']
